    ...
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {step === 1 && (
            ...
            >
              ...
              <button
                type="button"
                onClick={handleStep1}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
              >
                Devam Et
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {loading ? (
                    <>
        ...
        <p className="text-center text-xs leading-relaxed text-gray-400">
          Kayıt olarak{" "}
          <Link href="#" className="text-blue-600 hover:underline">Kullanım Koşulları</Link>
          {" "}ve{" "}
          <Link href="#" className="text-blue-600 hover:underline">Gizlilik Politikası</Link>
