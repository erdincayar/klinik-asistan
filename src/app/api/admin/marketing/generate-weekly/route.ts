...
[
  {"type": "tweet"|"thread"|"poll", "content": "ana metin", "threadContent": ["tweet1", "tweet2", ...] (sadece thread için), "pollOptions": ["seçenek1", "seçenek2"] (sadece poll için), "scheduledAt": "YYYY-MM-DDTHH:mm:00", "occasion": "kısa açıklama"}
]
