      ...
      <div className="space-y-4 py-2 max-h-[60vh] overflow-y-auto">
        ...
        <div className="space-y-3 rounded-lg border p-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            >
              <Eye className={`h-5 w-5 ${form.roleTemplate === "view_only" ? "text-[#c75b12]" : "text-gray-400"}`} />
      ...
      <Dialog open={showSalaryUpdateModal} onOpenChange={setShowSalaryUpdateModal}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <label className={`flex items-start gap-3 rounded-lg border p-3 cursor-pointer transition-colors ${salaryUpdateMode === "forward_only" ? "border-[#fde5d0] bg-[#fef4ec]/50" : "border-gray-200"}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-2 mb-2">
                ...
                <button type="button" onClick={() => setForm({ ...form, roleTemplate: "view_only", permissions: { ...viewOnlyPermissions } })} className={`text-xs font-medium rounded-lg border-2 p-2 transition-all ${form.roleTemplate === "view_only" ? "border-[#c75b12] bg-[#fef4ec] text-[#9e4a0f]" : "border-gray-200"}`}>
                  Sadece Görüntüle
                </button>
