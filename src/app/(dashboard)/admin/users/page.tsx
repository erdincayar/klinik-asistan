      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-white py-2.5 pl-10 pr-4 text-sm outline-none focus:border-[#E0E7FF] focus:ring-2 focus:ring-[#6366F1]/20"
          />
        </div>
        <div className="relative">
          ...
          <select
            ...
            className="appearance-none rounded-xl border border-gray-200 bg-white py-2.5 pl-10 pr-10 text-sm outline-none focus:border-[#E0E7FF] focus:ring-2 focus:ring-[#6366F1]/20"
          >
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-[#E0E7FF] focus:ring-2 focus:ring-[#6366F1]/20"
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#1E1E2D] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#2A2A3C] disabled:opacity-50"
                >
                  {saving ? (
                ...
                <div className="flex items-center justify-between rounded-xl border border-gray-200 px-4 py-3">
                  ...
                  <button
                    ...
                    className={`relative h-6 w-11 rounded-full transition-colors ${
                      editActive ? "bg-[#1E1E2D]" : "bg-gray-300"
                    }`}
                  >
                    <span
