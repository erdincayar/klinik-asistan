    ...
    <div className="flex items-center justify-center gap-1 mb-6">
      {STEPS.map((label, i) => (
        <div key={label} className="flex items-center gap-1">
          ...
          {i < STEPS.length - 1 && (
            <div className={cn("h-px w-8 mb-4", i < currentStep ? "bg-[#1E1E2D]" : "bg-gray-200")} />
          )}
        </div>
      ))}
    </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        >
                          <Zap className={cn("h-4 w-4", mode === "smart" ? "text-[#6366F1]" : "text-gray-400")} />
                          <div>
                            <p className={cn("text-xs font-semibold", mode === "smart" ? "text-[#4F46E5]" : "text-gray-700")}>Akıllı</p>
                        ...
                        >
                          <SlidersHorizontal className={cn("h-4 w-4", mode === "manual" ? "text-[#6366F1]" : "text-gray-400")} />
                          <div>
                            <p className={cn("text-xs font-semibold", mode === "manual" ? "text-[#4F46E5]" : "text-gray-700")}>Manuel</p>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="rounded-xl bg-[#EEF2FF] p-3 text-center">
                        <p className="text-xl font-bold text-[#4F46E5]">{preview.total}</p>
                        <p className="text-[10px] font-medium text-[#6366F1]">Toplam Müşteri</p>
                      </div>
                ...
                {creating && (
                  <div className="space-y-2">
                    <div className="h-2 overflow-hidden rounded-full bg-gray-100">
                      <motion.div
                        className="h-full bg-[#1E1E2D] rounded-full"
                        initial={{ width: "0%" }}
