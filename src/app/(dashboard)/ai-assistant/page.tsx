  ...
  const sendMessage = async (content: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMessages([...newMessages, { role: "assistant", content: "Uzgunum, bir hata olustu. Lutfen tekrar deneyin." }]);
      }
    } catch {
      setMessages([...newMessages, { role: "assistant", content: "Baglanti hatasi. Lutfen tekrar deneyin." }]);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <div className="border-b p-4">
        ...
        <p className="text-sm text-muted-foreground">
          Klinik verileriniz hakkinda sorular sorun
        </p>
      </div>
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Klinik verileriniz hakkinda sorular sorabilirsiniz. Gelir-gider analizi, hasta sorgulama ve daha fazlasi.
            </p>
