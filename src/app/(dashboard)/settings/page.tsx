    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2 border-b border-gray-100 px-6 py-4">
          <SettingsIcon className="h-4 w-4 text-[#6366F1]" />
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 pr-10 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#6366F1] focus:outline-none focus:ring-2 focus:ring-[#6366F1]/20"
                    placeholder="EAA..."
                  />
                  <button
                    type="button"
              ...
              {metaHowTo && (
                <div className="rounded-xl bg-gray-50 px-4 py-3 text-xs text-gray-600 space-y-2">
                  ...
                  <p className="flex items-center gap-1 text-[#6366F1]">
        ...
        <div className="p-6">
          {telegramLoading ? (
            ...
            <div className="text-center">
              <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-xl bg-[#EEF2FF]">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[#1E1E2D] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#2A2A3C]"
              >
      ...
      >
        ...
        <div className="p-6 space-y-6">
          {(() => {
            ...
            const barColor = pct >= 100 ? "bg-red-500" : pct >= 95 ? "bg-red-400" : pct >= 80 ? "bg-orange-500" : "bg-[#EEF2FF]0";
              ...
              {[
                ...
                <div key={pkg.id} className="rounded-xl border border-gray-100 p-4 text-center">
                  ...
                  <button
                    ...
                    className="mt-3 w-full rounded-lg bg-[#1E1E2D] px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-[#2A2A3C] disabled:opacity-50"
                  >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        reminder.isActive ? "bg-[#1E1E2D]" : "bg-gray-300"
                      }`}
                    >
                      <span
          ...
          <form onSubmit={handleAddReminder} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                required
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-[#6366F1] focus:outline-none focus:ring-2 focus:ring-[#6366F1]/20"
              >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {status === "invited" && (
                        <>
                          ...
                          <button
                            ...
                            className="rounded-lg px-2.5 py-1.5 text-xs font-medium text-[#6366F1] hover:bg-[#EEF2FF] transition-colors disabled:opacity-50"
                          >
                      ...
                      {status === "not_invited" && (
                        <button
                          ...
                          disabled={inviteLoading === emp.id}
                          className="flex items-center gap-1.5 rounded-lg bg-[#1E1E2D] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#2A2A3C] transition-colors disabled:opacity-50"
                        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 p-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-[#1E1E2D] px-3 py-1.5 text-xs font-semibold text-white hover:bg-[#2A2A3C] transition-colors"
              >
