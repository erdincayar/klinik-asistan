...
export function getHelpText(): string {
  return [
    ...
    "",
    "✅ Yapilacaklar (kisisel to-do):",
    "/yap [gorev]            - Yeni yapilacak ekle",
    "/yap [gorev] | [not]    - Notlu yapilacak ekle",
    "/liste                  - Aktif yapilacaklarin listesi",
    "/yapildi [no/kelime]    - Yapilacagi tamamlandi yap",
    "/sil [no/kelime]        - Yapilacagi sil",
    "",
    "📷 Fotograf Komutlari:",
