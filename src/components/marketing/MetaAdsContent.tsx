    ...
    return (
      <div className="space-y-6">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="flex items-center gap-2">
          <Megaphone className="h-5 w-5 text-[#6366F1]" />
          <h2 className="text-lg font-semibold text-gray-900">Pazarlama</h2>
        </motion.div>
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 }} className="flex min-h-[400px] items-center justify-center rounded-xl border border-gray-100 bg-white">
          <div className="text-center max-w-md px-6">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-xl bg-[#EEF2FF]">
            ...
            <Link href="/settings" className="inline-flex items-center gap-2 rounded-xl bg-[#1E1E2D] px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#2A2A3C]">
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button onClick={handleAnalyze} disabled={analyzing} className="inline-flex items-center gap-1.5 rounded-xl bg-[#1E1E2D] px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#2A2A3C] disabled:opacity-50">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.03 }} className="flex gap-2">
        {([
          ...
          const Icon = tab.icon;
          return (
            <button key={tab.key} onClick={() => setActiveTab(tab.key)} className={`inline-flex items-center gap-1.5 rounded-xl px-4 py-2.5 text-xs font-semibold transition-all ${activeTab === tab.key ? "bg-[#1E1E2D] text-white shadow-sm" : "bg-white text-gray-600 border border-gray-200 hover:bg-gray-50"}`}>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-6">
            {[
              ...
              { label: "Toplam Gosterim", value: formatNum(campaignStats.totalImpressions), icon: Eye, color: "text-[#6366F1]", bg: "bg-[#EEF2FF]" },
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-4 space-y-3">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {DATE_PRESETS.map((p) => (
                  <button key={p.key} onClick={() => setCampaignsDatePreset(p.key)} className={`rounded-lg px-3 py-1.5 text-[11px] font-semibold transition-all ${campaignsDatePreset === p.key ? "bg-[#1E1E2D] text-white" : "bg-gray-50 text-gray-600 hover:bg-gray-100"}`}>
                    {p.label}
                  </button>
                ))}
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input type="date" value={customDateStart} onChange={(e) => setCustomDateStart(e.target.value)} className="rounded-lg border border-gray-200 px-2.5 py-1.5 text-[11px] text-gray-700 focus:border-[#6366F1] focus:outline-none" />
              <span className="text-[11px] text-gray-400">—</span>
              <input type="date" value={customDateEnd} onChange={(e) => setCustomDateEnd(e.target.value)} className="rounded-lg border border-gray-200 px-2.5 py-1.5 text-[11px] text-gray-700 focus:border-[#6366F1] focus:outline-none" />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {OBJECTIVE_FILTERS.map((f) => (
                  <button key={f.key} onClick={() => setObjectiveFilter(f.key)} className={`rounded-lg px-3 py-1.5 text-[11px] font-semibold transition-all ${objectiveFilter === f.key ? "bg-[#1E1E2D] text-white" : "bg-gray-50 text-gray-600 hover:bg-gray-100"}`}>
                    {f.label}
                  </button>
                ))}
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex flex-wrap gap-1.5">
                {STATUS_FILTERS.map((f) => (
                  <button key={f.key} onClick={() => setStatusFilter(f.key)} className={`rounded-lg px-3 py-1.5 text-[11px] font-semibold transition-all ${statusFilter === f.key ? "bg-[#1E1E2D] text-white" : "bg-gray-50 text-gray-600 hover:bg-gray-100"}`}>
                    {f.label}
                  </button>
                ))}
              </div>
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex gap-1.5">
              {INSIGHTS_DATE_PRESETS.map((p) => (
                <button key={p.key} onClick={() => setInsightsDatePreset(p.key)} className={`rounded-lg px-3 py-1.5 text-[11px] font-semibold transition-all ${insightsDatePreset === p.key ? "bg-[#1E1E2D] text-white" : "bg-white text-gray-600 border border-gray-200 hover:bg-gray-50"}`}>
                  {p.label}
                </button>
              ))}
            </div>
          ...
          {insightsLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
              {[
                { label: "Gosterim", value: formatNum(insightsStats.totalImpressions), icon: Eye, color: "text-[#6366F1]", bg: "bg-[#EEF2FF]" },
          ...
          {insightsLoading ? (
            ...
            <div className="flex min-h-[250px] items-center justify-center rounded-xl border border-gray-100 bg-white">
              <div className="text-center">
      ...
      {/* AI Analysis */}
      {analysis && (
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="rounded-xl border border-[#E0E7FF] bg-[#EEF2FF]/50 p-6">
